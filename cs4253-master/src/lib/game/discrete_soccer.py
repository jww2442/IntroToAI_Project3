...
class SoccerState(GameState):
    ...
    def reward(self, player_id):
        if not self.is_terminal:
            return None
        return 1000 if self.winner == self.players[player_id].team else -1000 #edited values from 10 and -10
